...
const variants = {
  primary: 'bg-rose-700 hover:bg-rose-800 text-white shadow-sm',
  secondary: 'bg-rose-100 hover:bg-rose-200 text-rose-800',
  outline: 'border-2 border-rose-700 text-rose-700 hover:bg-rose-50',
